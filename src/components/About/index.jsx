...
const text = {
  ...
  english: {
    ...
    about:
      "I'm a front end junior developer. I'm 28 years old and have a degree in IT and also in Industrial Automation. I started a bachelor degree in physics, but I didn't complete it. Although I like physics, I realized that my path is with technology. I started studying on my own, doing bootcamps and courses on udemy. Today I have enough baggage to get started in this web programming market. My focus is to start as a Junior, as many have started. I'm always programming and studying so I don't get left behind. In my spare time I like to watch series and also play online RPG games.",
  },
};
