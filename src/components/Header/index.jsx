      ...
      <Content>
        ...
        <Main isMenuOpen={isMenuOpen}>
          <ul>
            ...
            <li>
              <Link href="#personal-projects" onClick={handleMenuToggle}>
                {language === "portuguese"
                  ? "Projetos Pessoais"
                  : "Personal Projects"}
              </Link>
            ...
            <li>
              <Link href="#projects" onClick={handleMenuToggle}>
                {language === "portuguese" ? "Todos Projetos" : "All Projects"}
              </Link>
            </li>
            <li>
          ...
          <div className="switch_container">
            <div>
              <span>{language === "portuguese" ? "Tema" : "Theme"}</span>
              <Switch
                onChange={handleThemeToggle}
                checked={title === "light"}
                checkedIcon={
                  <img src={sunImg} alt="ligh mode" width={20} height={20} />
                }
                uncheckedIcon={
                  <img src={moonImg} alt="dark mode" width={20} height={20} />
                }
                height={20}
                width={45}
              />
            ...
            <div>
              <span>{language === "portuguese" ? "Idioma" : "language"}</span>
              <Switch
