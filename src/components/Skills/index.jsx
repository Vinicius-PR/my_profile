        ...
        <Container>
            ...
            <Content>
                <Knowledge>
                    ...
                    <div><img src={jsImg} alt="JavaScript" title='JavaScript'/><p>JavaScript</p></div>
                    <div><img src={cssImg} alt="CSS 3" title='CSS3'/> <p>CSS</p></div>
                    <div><img src={htmlImg} alt="HTML 5" title='HTML 5'/> <p>HTML</p></div>
                    <div><img src={reactImg} alt="React JS" title='React JS'/> <p>React JS</p></div>
                    <div><img src={sassImg} alt="Sass" title='Sass'/> <p>SASS</p></div>        
                    <div><img src={pythonImg} alt="Python" title='Python'/> <p>Python</p></div>       
                    <div><img src={styledComponents} alt="Styled Components" title='Styled Components'/> <p>Styled Components</p></div>       
                </Knowledge>

                <Knowledge>
                    <h3>{text[language].subtitle_2}</h3>

                    <div><img src={phpImg} alt="PHP" title='PHP'/> <p>PHP</p></div>
                    <div><img src={typeImg} alt="TypeScript" title='TypeScript'/> <p>TypeScript</p></div>   
                    <div><img src={reduxImg} alt="Redux" title='Redux'/> <p>Redux</p></div>
                </Knowledge>

                <Knowledge className='lastline'>
                    <h3>{text[language].subtitle_3}</h3>

                    <div><img src={graphImg} alt="GrapfQL" title='GrapfQL'/> <p>Graphql</p></div>
                    <div><img src={vueImg} alt="Vue" title='Vue'/> <p>VUE</p></div>           
                </Knowledge>
            </Content>
